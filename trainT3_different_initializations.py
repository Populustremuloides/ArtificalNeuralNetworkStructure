...
trainT3DataPath = "C:\\Users\\BCBrown\\PycharmProjects\\spectral_network\\DataGenerationScripts\\neg5to3\\train_t3_blockify_sequences.npy"
trainT3Data = np.load(trainT3DataPath)
print(len(trainT3Data))
...
testT3DataPath = "C:\\Users\\BCBrown\\PycharmProjects\\spectral_network\\DataGenerationScripts\\neg5to3\\test_t3_blockify_sequences.npy"
testT3Data = np.load(testT3DataPath)
print(len(testT3Data))
...
def trainModel(model):
    ...
    for epoch in range(epochs):
        ...
        for batch in range(numBatches):
            ...
            for index in indices:
                ...
                targetBatch.append(trainT3Data[index])
    ...
    for i in range(len(testData)):
        ...
        targetBatch = torch.tensor([testT3Data[i]])
...
outPath = "initialization_test_output_neg5_to_3_noT-T3"
...
for test in range(50):
    ...
    prefix = outPath + "\\noT-T3_" + str(test) + "_" + initializationType + "_"
